      ...
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <?php else : ?>
          <div class="form-group">
            <label class="comments-label" for="author"><?php _e('Name', 'roots'); if ($req) _e(' (required)', 'roots'); ?></label>
          ...
          <div class="form-group">
            <label class="comments-label" for="email"><?php _e('Email (will not be published)', 'roots'); if ($req) _e(' (required)', 'roots'); ?></label>
            <input type="email" class="form-control" placeholder="<?php _e('Email (will not be published)', 'roots'); if ($req) _e(' (required)', 'roots'); ?>" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" <?php if ($req) echo 'aria-required="true"'; ?>>
          </div>
          <div class="form-group">
            <label class="comments-label" for="url"><?php _e('Website', 'roots'); ?></label>
            <input type="url" class="form-control" placeholder="http://" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" size="22">
          </div>
        <?php endif; ?>
        <div class="form-group">
          <label class="comments-label" for="comment"><?php _e('Comment', 'roots'); ?></label>
